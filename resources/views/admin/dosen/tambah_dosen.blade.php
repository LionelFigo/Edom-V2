...
<div class="p-8">
    <div class="flex items-center gap-4 mb-10">
        ...
        <h1 class="text-2xl font-bold text-black tracking-wide">Tambah Data Dosen</h1>
    </div>
    ...
    <form action="{{ route('admin.dosen.store') }}" method="POST" enctype="multipart/form-data" class="max-w-3xl">
        @csrf
        ...
        <div class="space-y-5">
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                ...
                <div class="md:col-span-3">
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" placeholder="Masukkan nama dosen" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                ...
                <div class="md:col-span-3">
                    <input type="text" name="nip" id="nip" value="{{ old('nip') }}" placeholder="Masukkan NIP/NIDN" 
                        class="w-full border border-slate-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-[#004684]" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                ...
                <div class="md:col-span-3">
                    <input type="email" name="email" id="email" value="{{ old('email') }}" placeholder="Masukkan email untuk login dosen" 
                        class="w-full border border-slate-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-[#004684]" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                <label class="text-black font-semibold text-sm md:col-span-1">Upload Foto :</label>
                <div class="md:col-span-3 flex items-center">
                    ...
                    <span class="ml-3 text-sm text-slate-500" id="file-name-display"></span>
                </div>
            </div>
        </div>
        ...
        <div class="flex gap-3 mt-10">
            ...
            <button type="submit" class="px-8 py-2 bg-[#1877F2] hover:bg-blue-600 text-white rounded font-semibold transition shadow-sm text-sm">Simpan</button>
        </div>
    </form>
</div>
